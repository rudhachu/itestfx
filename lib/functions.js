const { cutAudio, cutVideo, toAudio, toPTT, isAdmin, isBotAdmin, getCompo, getDate, parsedJid, PREFIX, mode, extractUrlsFromString, getJson, isIgUrl, getUrl, isNumber, MediaUrls } = require('./connection');
const { commands } = require('./system/events')
...
async function sendAlive(m, ALIVE_DATA,obj) {
